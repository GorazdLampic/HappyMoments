...
// Copy static assets
const staticFiles = ['manifest.json', '_redirects', '_headers', 'gift-placeholder.svg', 'gift-placeholder.png', 'og-image.png', 'og-cover-v2.png'];
...
// Build version + timestamp — kept as a hidden HTML comment for support/debugging
// (view-source), NOT shown anywhere in the UI.
